...
windowed = t_env.sql_query("""
    SELECT
        text,
        HOP_START(created_at, INTERVAL '2' SECONDS, INTERVAL '10' SECONDS) AS w_start,
        HOP_END(created_at, INTERVAL '2' SECONDS, INTERVAL '10' SECONDS) AS w_end
    FROM tweets
    GROUP BY
        HOP(created_at, INTERVAL '2' SECONDS, INTERVAL '10' SECONDS),
        text
""")
